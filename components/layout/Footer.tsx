...
// SVG social icons (inline, vendor-neutral)
const socialLinks = [
  {
    label: 'Twitter / X',
    href: '#',
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map(({ label, href, icon }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
